...
export function toCreateBookingData(input: CreateBookingLinkInput, companyId: string): Prisma.BookingLinkUncheckedCreateInput {
  return {
    ...
    minScheduleNoticeMinutes: input.minScheduleNoticeMinutes,
    maxScheduleDays: input.maxScheduleDays,
    allowPublicCancellation: input.allowPublicCancellation,
    allowPublicReschedule: input.allowPublicReschedule,
    minCancelRescheduleMinutes: input.minCancelRescheduleMinutes,
...
export function toUpdateBookingData(input: UpdateBookingLinkInput): Prisma.BookingLinkUncheckedUpdateInput {
  return {
    ...
    ...(input.minScheduleNoticeMinutes !== undefined ? { minScheduleNoticeMinutes: input.minScheduleNoticeMinutes } : {}),
    ...(input.maxScheduleDays !== undefined ? { maxScheduleDays: input.maxScheduleDays } : {}),
    ...(input.allowPublicCancellation !== undefined ? { allowPublicCancellation: input.allowPublicCancellation } : {}),
    ...(input.allowPublicReschedule !== undefined ? { allowPublicReschedule: input.allowPublicReschedule } : {}),
    ...(input.minCancelRescheduleMinutes !== undefined ? { minCancelRescheduleMinutes: input.minCancelRescheduleMinutes } : {}),
...
export function publicLinkDto(link: NonNullable<Awaited<ReturnType<typeof getPublicBookingLink>>>) {
  ...
  return {
    ...
    duration: link.durationMinutes ?? link.duration,
